...
ld -m elf_i386 -T link.ld -o PDOS.bin kasm.o kc.o obj/isr.o obj/system.o obj/string.o obj/screen.o obj/kb.o obj/idt.o obj/util.o
ld -m elf_i386 -T link.ld -o PDOS.img kasm.o kc.o obj/isr.o obj/system.o obj/string.o obj/screen.o obj/kb.o obj/idt.o obj/util.o
